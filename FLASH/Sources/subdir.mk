...
Sources/TEMPERATURE_MANAGER_c.obj: ../Sources/TEMPERATURE_MANAGER.c
	@echo 'Building file: $<'
	@echo 'Executing target #11 $<'
	@echo 'Invoking: HCS08 Compiler'
	"$(HC08ToolsEnv)/chc08" -ArgFile"Sources/TEMPERATURE_MANAGER.args" -ObjN="Sources/TEMPERATURE_MANAGER_c.obj" "$<" -Lm="$(@:%.obj=%.d)" -LmCfg=xilmou
	@echo 'Finished building: $<'
	@echo ' '
